...
public class Boss : MonoBehaviour
{
    ...
    void SetHP()
    {
        ...
        maxEnemyHp = (BigInteger)((Mathf.Pow(10f, 1.1f) * (Mathf.Pow(1.06f, 10) - Mathf.Pow(1.06f, 10 + GameManager.Instance.stageLevel)) * 3 / (1 - 1.06f) * 2)*10);
    ...
    public void KillEnemy()
    {
        ...
        GameManager.Instance.money += maxEnemyHp / 2;
