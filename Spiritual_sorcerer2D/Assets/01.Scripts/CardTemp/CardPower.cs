...
[CreateAssetMenu(fileName ="CardPower",menuName ="AfterSchool/CardGame/CardPower")]
public class CardPower : ScriptableObject
{
    ...
    public void Init(Sprite _illust, string _name, string _description, 
        string _seqOnUse, string _seqOnDraw, string _seqOnDrop, string _seqTrunEnd) 
    {
        this.illust = _illust;
        this.cardName = _name;
